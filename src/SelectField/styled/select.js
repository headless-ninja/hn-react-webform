...
export default styled(Select)`
  ...
  */
  ...
  .Select-control {
    ...
    height: ${p => p.theme.inputLineHeight};
  ...
  .Select input,
  .Select span {
    line-height: calc(${p => p.theme.inputLineHeight} + (${p => p.theme.spacingUnit} / 2));
  }
  ...
  .Select-menu-outer {
    ...
    border-bottom-color: ${p => p.theme.borderColor};
    border-left-color: ${p => p.theme.borderColor};

  ...
  constructor(props) {
    ...
    rules.set(`date_${props.field['#webform_key']}`, {
      ...
      hint: () =>
        (<RuleHint
          ...
          hint={WebformUtils.getCustomValue(props.field, 'dateError', props.settings) || WebformUtils.getErrorMessage(props.field, '#required_error') || 'Please enter a valid date.'}
        />),
    ...
    rules.set(`date_range_${props.field['#webform_key']}`, {
      ...
      hint: (value) => {
        ...
        switch(result.type) {
          case 'before':
            hint = WebformUtils.getCustomValue(props.field, 'dateBeforeError', props.settings) || WebformUtils.getErrorMessage(props.field, '#required_error') || 'Please enter a date before {{max}}';
            break;
          case 'after':
            hint = WebformUtils.getCustomValue(props.field, 'dateAfterError', props.settings) || WebformUtils.getErrorMessage(props.field, '#required_error') || 'Please enter a date after {{min}}';
            break;
          default:
          case 'range':
            hint = WebformUtils.getCustomValue(props.field, 'dateRangeError', props.settings) || WebformUtils.getErrorMessage(props.field, '#required_error') || 'Please enter a date between {{min}} and {{max}}';
            break;
        }
